...
description: "The conversation and streaming types shared by every DeepSeek Harness model request: Message, ContentBlock variants, StreamChunk protocol, and the LlmAdapter contract."
---
