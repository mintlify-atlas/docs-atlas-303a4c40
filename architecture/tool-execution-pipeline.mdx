---
title: "Tool Execution Pipeline in DeepSeek Harness"
sidebarTitle: "Tool Pipeline"
description: "How tool calls flow through the DeepSeek Harness execution pipeline: from model request through pre-execute policy, dispatch, post-execute transformation, and result observation."
---
