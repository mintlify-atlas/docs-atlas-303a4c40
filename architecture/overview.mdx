...
description: "How DeepSeek Harness composes a plugin tree from profiles and bundles, the seven core packages, and where new behavior attaches in the system."
---
