...
description: "Every plugin config block available in cordis.yml for DeepSeek Harness. Generated from source; covers all loadable packages and their declared configuration types."
---
